...
const movieSchema = z.object({
    ...
    genre: z.array(z.enum(['Action', 'Comedy', 'Drama', 'Fantasy', 'Horror', 'Mystery', 'Romance', 'Thriller', 'Western','Crime'])).min(1, {invalid_type_error: 'Genre must be a non-empty array of strings'}),
